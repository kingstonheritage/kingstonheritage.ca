<div id="widgetkit" class="wrap">
	...
	<?php echo $this['template']->render('title', array('title' => ($widget->id ? 'Edit' : 'Add').' Accordion')); ?>

	<form id="form" method="post" action="<?php echo $this['system']->link(array('task' => 'save_accordion')); ?>">
        ...
        <div class="form">
            ...
            <?php
                ...
                foreach ($widget->items as $id => $item) {
                    echo $this->render('accordion:layouts/item', compact('id', 'item', 'widget', 'style_xml'));
                }
