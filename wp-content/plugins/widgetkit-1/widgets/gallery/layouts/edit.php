<div id="widgetkit" class="gallery wrap" data-token="<?php echo $this["system"]->token;?>">
			...
			<div class="box">
				...
				<div class="content">
					<div class="wk-button-group">
						<a class="create-folder" title="Create Folder" href="#">Create Folder</a>
						/ <a class="delete-folder" title="Delete Folder" href="#">Delete Folder</a>
					</div>
